...
export default function Login() {
    ...
    return (
        <div className=" text-text flex flex-col justify-center items-center min-h-[calc(100vh-100px)]">
            <h1 className="text-4xl text-accent font-bold mb-3">E-Bazaar</h1>
            <p className=" text-text/75 mb-6">E-Bazaar Management System - Employee Login</p>
