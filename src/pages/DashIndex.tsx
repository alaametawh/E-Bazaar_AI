import { ShoppingCart, PackageSearch, Package } from 'lucide-react';
    ...
    return(
        <div className='flex flex-col'>
            <div className=" flex flex-col gap-4 mb-8 lg:flex-row justify-between items-center mx-3 lg:mx-0">
                <div className=" border-2 bg-[#292825] hover:bg-[#33322f] border-accent p-6 w-full lg:w-1/3 rounded-2xl flex flex-row justify-between items-center">
